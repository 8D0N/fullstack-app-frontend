    ...
    const list = () => (
        <Box sx={{ width: 240 }}>
            ...
            <List>
                ...
                <Divider />
                <ListItem component="a" href="/inventory/import/sales" disablePadding>
                    <ListItemButton>
    ...
    return (
        <ThemeProvider theme={defaultTheme}>
            <Box sx={{ display: "flex" }}>
                ...
                <Drawer open={open} onClose={() => toggleDrawer(false)} anchor="left">{list()}</Drawer>
                <Drawer anchor="left">
                    <Box sx={{ width: 240 }}>
                        <Toolbar>
                            <Divider>
                ...
                >
                    <Typography variant="caption" color="whote">
                        @2025 full stack web development
                    </Typography>
                </Box>
            </Box>
        </ThemeProvider>
